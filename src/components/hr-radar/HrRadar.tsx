    ...
    <div>
      ...
      <div className="mt-5 rounded-2xl border border-brand/20 bg-brand-tint p-4">
        ...
        <p className="mt-1 max-w-4xl text-xs leading-5 text-muted">
          RSS Минтруда и ChatGPT с веб-поиском проверяют российские и международные
          источники за последние 72 часа. Русская выжимка и исходная ссылка сначала
          попадают в закрытую очередь «На проверке» и не публикуются автоматически.
          Текущая видимая лента проверена редактором {HR_NEWS_REVIEW_DATE}.
        </p>
      </div>
      ...
      <div className="mt-5 grid gap-5 xl:grid-cols-[minmax(0,1fr)_320px]">
        ...
        <aside className="h-fit rounded-2xl border border-border bg-surface p-5 shadow-sm">
          ...
          <div className="mt-5 rounded-xl bg-warning-tint p-3 text-xs leading-5 text-warning">
            Минтруд собирается по RSS, другие свежие публикации обнаруживает
            ChatGPT с веб-поиском. Дубликаты отсеиваются, полный текст статьи не
            копируется, а новая карточка становится видимой только после проверки HR.
          </div>
        </aside>
      </div>
    </div>
