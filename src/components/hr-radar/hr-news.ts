...
export interface HrNewsSource {
  ...
  updateMode: "Автоматически" | "Через веб-поиск" | "Вручную";
}
...
export const HR_NEWS_SOURCES: HrNewsSource[] = [
  ...
  },
  {
    ...
    note: "Отраслевая аналитика и обновления инструментов найма; ChatGPT ищет свежие публикации, но в ленту они попадают только после проверки.",
    status: "Источник проверен",
    updateMode: "Через веб-поиск",
  },
  {
    name: "CIPD",
    url: "https://www.cipd.org/en/about/news/",
    note: "Публичные материалы профессиональной ассоциации; международные публикации получают русскую выжимку и сохраняют исходную ссылку.",
    status: "Источник проверен",
    updateMode: "Через веб-поиск",
  },
];
